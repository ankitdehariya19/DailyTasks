...
export default function Home() {
    ...
    return !authUser ? (
        ...
        <main className=" h-full">
            ...
            <div className="max-w-3xl mx-auto mt-10 p-8 shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(45,78,255,0.15)] ">
                <div className="bg-white -m-6 p-3 sticky top-0">
                    ...
                    <div className="flex items-center gap-2 mt-10">
                        <input
                            ...
                            type="text"
                            className="font-semibold placeholder:text-gray-500 border-[2px] border-black h-[60px] grow shadow-sm rounded-md px-4 focus-visible:outline-green-400 text-lg transition-all duration-300 shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(45,78,255,0.15)]"
                            autoFocus
                            value={todoInput}
                ...
                <div className="my-10">
                    ...
                    {todos.length < 1 && (
                        <span className="text-center w-full block text-2xl font-medium text-gray-400 mt-28">{`🥹 "Task by Task: Building a More Productive You"`}</span>
                    )}
                </div>
            </div>
        </main>
